...
-- Listage des données de la table ollert_db.member : ~2 rows (environ)
...
-- Listage des données de la table ollert_db.member_project : ~0 rows (environ)
...
-- Listage des données de la table ollert_db.state : ~0 rows (environ)
...
-- Listage des données de la table ollert_db.task : ~0 rows (environ)
...
INSERT INTO `member` (`id`, `username`, `email`, `Hash`, `Salt`, `createdAt`, `updatedAt`) VALUES
    ...
    -- Listage des données de la table ollert_db.project : ~0 rows (environ)
/*!40000 ALTER TABLE `project` DISABLE KEYS */;
INSERT INTO `project` (`id`, `name`, `type`, `description`, `deadline`, `id_manager`, `createdAt`, `updatedAt`) VALUES
	(1, 'project 1', 'IT', 'no desc', '2021-12-29', 25, '2021-12-26 00:01:23', '2021-12-26 00:01:24');
    INSERT INTO `member_project` (`id_member`, `id_project`, `createdAt`, `updatedAt`) VALUES
	(27, 1, '2021-12-26 00:21:08', '2021-12-26 00:21:09');
